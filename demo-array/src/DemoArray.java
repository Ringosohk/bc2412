...
public class DemoArray {
  public static void main(String[] args) {
    ...
    //step 1:i=0.98 > 0 ->ture -> put 98 to max
    //step 2:i=0.99 >0 ->ture -> put 99 to max
    //step 3:i=0.97 > 0 ->ture -> exit
    ...
    //swap
    int left = 7; //memory loaction
    int right = 9;//location
    ...
    // array
    int[]arr8 =  new int[] {9, -8, 189, 99, 98};
  ...
  System.out.println(arr8[i] + arr8[i+1]);
    ...
    // array swap
    int[]arr7 =  new int[] {9, -8, 189,99,98};
