public class DemoString {
  public static void main(String[]args){
     ...
     //!define a String value by doublke quote""
     //!define a String value by single quote''
     ...
     char result = password.charAt(0);// 0 represnts the first position of the string value
     ...
     String s = "hello";
     System.out.println("hello".equals(s));//asing if s equals to "hello"
     ...
     //! s5's value dosen't change
     //!substr is strong a new String value returned by "substring"
