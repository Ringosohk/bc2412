...
public class DemoBigcimal {
  ...
  public static void main(String[] args) {
    ...
    if (result == 0.3){
     ...
     BigDecimal bd6 =bd1.add(bd5);
     System.out.println(bd3.doubleValue());//0.2
     //substract
     ...
     System.out.println(bd3.doubleValue());//0.02
     ...
     System.out.println(bd15.doubleValue());//Non-terminating decimalexpansion
     ...
     System.out.println(bd19.setScale(2, RoundingMode.HALF_DOWN));//4.57
     BigDecimal bd20 = BigDecimal.valueOf(4.569);
     System.out.println(bd20.setScale(2, RoundingMode.HALF_UP));//4.56
     ...
     double circleArea=BigDecimal.valueOf(radius)//
      ...
      //  int[]arr = new int[]{10,0,3};
      //  max = Integer.MIN_VALUE;
      //  max = Math.max(x,max);// of (x>max){max=x;}
      //  max = Math.max(y,max);
       ...
       //Math.min()
       System.out.println(Math.sqrt(9));//Java auto convert int value to duble value
